// VGA 8x16 font (256 glyphs, code points 0..255).
// Glyph rows are 1 byte each, MSB = leftmost pixel.
// Extracted from textport_code/cpm-bitmap-test.cpp.
...
constinit const Font font_8x16 = {
    /*width =*/ 8,
    /*height=*/ 16,
    /*stride=*/ 1,
    /*mask  =*/ 0xFF,
...
constinit const FontRenderer font_8x16_renderer = {
    /*font        =*/ &font_8x16,
    /*draw_cell   =*/ &GlyphBlit<8, 16, 1, 0xFF>::draw_cell,
    /*invert_cell =*/ &GlyphBlit<8, 16, 1, 0xFF>::invert_cell,
    /*clear_row   =*/ &GlyphBlit<8, 16, 1, 0xFF>::clear_row,
};

const uint8_t font_8x16_bits[256 * 16] = {
